...
rawdf <- read.csv("data/download/raw/Shortia_galacifolia_raw_20220505.csv")
...
# 7. Save Cleaned.csv
write.csv(df, "data/cleaning_demo/Shortia_galacifolia_20220505-cleaned.csv", row.names = FALSE)
...
## Save Maxent.csv
write.csv(alldf, "data/cleaning_demo/maxent_ready/diapensiaceae_maxentready_20220505.csv", row.names = FALSE)
