...
#### Save as csv files 
write.csv(iDigBio_GU, "data/download/iDigBio_GU_20220505.csv", row.names = FALSE)
write.csv(iDigBio_GU_family, "data/download/iDigBio_GU_family_20220505.csv", row.names = FALSE)
...
spocc_combine(Shortia_galacifolia, "data/download/raw/Shortia_galacifolia_raw_20220505.csv")
spocc_combine(Galax_urceolata, "data/download/raw/Galax_urceolata_raw_20220505.csv")
spocc_combine(Pyxidanthera_barbulata, "data/download/raw/Pyxidanthera_barbulata_raw_20220505.csv")
spocc_combine(Pyxidanthera_brevifolia, "data/download/raw/Pyxidanthera_brevifolia_raw_20220505.csv")
